...
/**
 * La clase {@code Invitacion} gestiona la programación y envío de invitaciones.
...
public class Invitacion {
    ...
    /**
     * Crea una nueva instancia de {@code Invitacion} con la hora especificada.
     *
    ...
    /**
     * Devuelve una representación en forma de cadena de la instancia {@code Invitacion}.
     * 
     * @return Una cadena que representa la invitación con la hora y el número total de invitados.
     */
    @Override
    public String toString() {
        return String.format("Invitacion{hora=%s, total de invitados=%d}", hora, invitados.size());
    }
}
